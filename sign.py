...
import sys
from test_files.emailautomation import EmailSender
import os
...
class SignEntry(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.logomin_1.setPixmap(QPixmap("assets/images/logomin.png"))
        ...
        def signup_success():
            ...
            if AuthManager(None, None, None, None).signup(
                ...
                # ...existing code...
                EmailSender(self.email_line.text().strip(),self.username_line.text().strip()).send_email()
                # ...existing code...
        ...
        self.logomin_2.setPixmap(QPixmap("assets/images/logomin.png"))
