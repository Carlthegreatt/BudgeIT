...
################################################################################
## Form generated from reading UI file 'mainwindowUNapEj.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("background-color: rgb(229, 188, 255);")
        ...
        icon8 = QIcon()
        icon8.addFile(
            ":/notificationdark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon9 = QIcon()
        icon9.addFile(":/profiledark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(":/morepurple.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.scrollAreaWidgetContents_1.setGeometry(QRect(0, 0, 779, 792))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, -3, 760, 813))
        ...
        self.submitbtn.setMinimumSize(QSize(80, 34))
        self.submitbtn.setMaximumSize(QSize(10, 16777215))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 644, 707))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.monthlyreport_lbl.setText(
            QCoreApplication.translate("MainWindow", "Report as of May 2025", None)
        )
